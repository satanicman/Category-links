...
class LinkBlockType extends TranslatorAwareType
{
    ...
    /**
     * @var array $categoryPageChoices
     */
    private $categoryPageChoices;
     ...
     * @param array $categoryPageChoices
     */
    public function __construct(
        ...
        $this->categoryPageChoices = $categoryPageChoices;
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('category', ChoiceType::class, [
                'choices' => $this->categoryPageChoices,
